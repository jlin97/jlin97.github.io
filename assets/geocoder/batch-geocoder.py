...
API_KEY = 'AIzaSyDfl3qItgBC9ozKIy2gBCBBRxIYIuj1Tmw'
# Backoff time sets how many minutes to wait between google pings when your API limit is hit
BACKOFF_TIME = 30
# Set your output file name here.
output_csv_filename = 'data/location_output.csv'
output_json_filename = 'data/location_output.json'
...
pd.DataFrame(results).to_csv(output_csv_filename, encoding='utf8')
pd.DataFrame(results).to_json(output_json_filename, orient='records')
